<!-- Hero Section -->
<section class="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div class="text-left order-2 lg:order-1">
                ...
                <h1 class="text-4xl md:text-6xl font-bold text-white mb-4 animate-fade-in-up text-shadow-lg">
                    Hi, Saya <span class="text-yellow-300">Bayu</span>
                </h1>

                <p class="text-xl md:text-2xl text-white/90 mb-6 animate-fade-in-up animation-delay-200 text-shadow">
                    Fresh Graduate Teknik Informatika
                </p>

                <!-- Tagline -->
                <p class="text-lg text-white/80 mb-10 animate-fade-in-up animation-delay-400 text-shadow max-w-xl">
                    Saya merancang aplikasi web yang indah dan responsif dengan teknologi modern. Saya
                    bersemangat menciptakan pengalaman digital yang berpusat pada pengguna dan
                    membawa perubahan.
                </p>
            ...
            <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
                <div class="relative">
                    <div class="w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-white/50 shadow-2xl backdrop-blur-sm animate-fade-in-up">
                        <img src="<?= base_url('images/profile.jpg') ?>"
                            alt="Profile Picture"
                            class="w-full h-full object-cover"
                            onerror="this.src='data:image/svg+xml;base64,'; this.parentElement.classList.add('flex', 'items-center', 'justify-center', 'bg-gradient-to-br', 'from-indigo-500', 'to-purple-600');">
                    </div>
                    <div class="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 rounded-full border-4 border-white animate-pulse"></div>

                    <!-- Decorative elements -->
                    <div class="absolute -top-4 -left-4 w-20 h-20 bg-gradient-to-r from-blue-300 to-indigo-300 rounded-full opacity-60 animate-pulse-slow"></div>
